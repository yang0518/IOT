...
public class CodeController extends BaseController {
    ...
    @ResponseBody
    public Object generate(@RequestBody GenQo genQo) {
    	System.out.println("-------genQo.getTableName:"+genQo.getTableName());
    	System.out.println("-------genQo.getAuthor:"+genQo.getAuthor());
    	System.out.println("-------genQo.getModuleName:"+genQo.getModuleName());
    	System.out.println("-------genQo.getProjectPackage:"+genQo.getProjectPackage());
