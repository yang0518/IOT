...
public class GunsProperties {
    ...
    private String iotapiBaseUrl = "http://5union.com/iotapi/";
	...
	public String getIotapiBaseUrl() {
		return iotapiBaseUrl;
	}

	public void setIotapiBaseUrl(String iotapiBaseUrl) {
		this.iotapiBaseUrl = iotapiBaseUrl;
	}
