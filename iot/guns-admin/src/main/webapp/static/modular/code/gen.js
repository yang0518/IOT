...
Code.generate = function () {
    ...
    this.set('projectPath').set('author').set('projectPackage').set('corePackage').set('ignoreTabelPrefix').set('bizName').set('moduleName').set('parentMenuName').set('tableName');
    ...
    baseAjax.setContentType("application/json;charset=UTF-8");
    baseAjax.start();
};
